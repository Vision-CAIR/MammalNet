...
class TestMeter(object):
    ...
    def update_stats(self, preds, labels, clip_ids,data_type):
        ...
        # print("self.ensemble_method", self.ensemble_method)
    ...
    def finalize_metrics(self, ks=(1, 5)):
        ...
        if self.multi_label:
            ...
            # print("animal",num_topks_correct_animal)
            # print("behavior", num_topks_correct_behavior)
            # print("composition",num_topks_correct_composition)
    ...
    def finalize_metrics_per_class(self, ks=(1, 5)):
        ...
        if self.multi_label:
            ...
            for animal in unique_animal_labels:
                ...
                # print(sub_label.shape,sub_pred.shape)
    ...
    def classify_longtail_classes(self,file):
        ...
        for key in composition_dict.keys():
            ...
            if animal_frequency > 300 and behavior_frequency > 1000:
                ah_bh.append(key)
            elif animal_frequency <= 300 and animal_frequency >100 and behavior_frequency > 1000:
                am_bh.append(key)
            elif animal_frequency <= 100 and behavior_frequency > 1000:
                af_bh.append(key)
            elif animal_frequency > 300 and behavior_frequency > 300:
                ah_bm.append(key)
            elif animal_frequency <=300 and animal_frequency > 100 and behavior_frequency >300:
                am_bm.append(key)
            elif animal_frequency <=100 and behavior_frequency >300:
                af_bm.append(key)
            elif animal_frequency >300 and behavior_frequency <=300:
                ah_bf.append(key)
            elif animal_frequency >100 and animal_frequency <=300 and behavior_frequency <=300:
                am_bf.append(key)
            elif animal_frequency <=100 and behavior_frequency <=300:
                af_bf.append(key)
    ...
    def finalize_metrics_group_by_counterpart(self, ks=(1, 5)):
        ...
        if self.multi_label:
            ...
            # print("the length of behavior", len(behavior_dict))
            
            for key in behavior_dict.keys():
                # print(behavior_dict[key])
            ...
            print("the length of animal_per_behavior accuracy",len(animal_per_behavior_accuracy))


            with open("animal_per_behavior_accuracy_pretrained.pkl","wb") as f:
                pkl.dump(animal_per_behavior_accuracy,f)


            print(animal_per_behavior_accuracy)
            ...
            for behavior in unique_behavior_labels:
                ...
                with open("behavior_per_animal_accuracy_pretrained.pkl","wb") as f:
                    pkl.dump(behavior_per_animal_accuracy,f)
                ...
                # print(behavior_per_animal_accuracy)
    ...
    def finalize_metrics_long_tail(self, ks=(1, 5)):
        ...
        if self.multi_label:
            ...
            # print("unique animal labels", len(unique_animal_labels))
            ...
            with open(self.output_dir+"/animal_prediction.txt","w") as f:
                for animal in unique_animal_labels:
                    ...
                    # for each_pred, each_label in zip(sub_pred, sub_label):
                    #     print(type(each_pred), type(each_label))
                    #     print(each_pred, each_label)
                    #     assert False
                    #     f.write(each_pred+" "+each_label+"\n")
                    ...
                    for each_pred, each_label in zip(pred_index_top1, gt_index_top1):
                        ...
                        if each_pred.shape[0] >1:
                            for each_sub_pred, each_sub_label in zip(each_pred, each_label):
                                # print(str(each_sub_pred.item())+" "+str(each_sub_label.item()))
                                f.write(str(each_sub_pred.item())+" "+str(each_sub_label.item())+"\n")
                        else:
                            # print(str(each_pred.item())+" "+str(each_label.item()))
            ...
            # print(number_animal_head,number_animal_med, number_animal_tail)
            ...
            with open(self.output_dir+"/animal_result.pkl","wb") as f:
                pkl.dump(unique_animal_result,f)
            ...
            with open(self.output_dir+"/behavior_result.pkl","wb") as f:
                pkl.dump(unique_behavior_result,f)
            ...
            with open(self.output_dir+"/composition_prediction_result.pkl","wb") as f:
                pkl.dump(unique_composition_result,f)




            # print(number_composition_head,number_composition_med, number_composition_tail)
