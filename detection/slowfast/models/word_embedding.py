...
def load_fasttext_embeddings_mammalnet(vocab):
    ...
    import fasttext.util
    ft = fasttext.load_model('/ibex/ai/project/c2133/benchmarks/mvit2/SlowFast/slowfast/models/fasttext_pretrained/cc.en.300.bin')
    embeds = []
    for k in vocab:
        if '_' in k:
            ks = k.split('_')
...
def test_word_embedding():
    ...
    with open("/ibex/ai/project/c2133/benchmarks/mvit2/SlowFast/animalnet_trimmed_last/genus_to_id.pkl","rb") as f:
        data = pkl.load(f)
