...
class TestMeter(object):
    ...
    def finalize_metrics(self, ks=(1, 5)):
        ...
        if self.multi_label:
            ...
            # print(" the shape of video preds",self.video_preds.shape)
            # print(" the shape of video labels", self.video_labels.shape)
            # print("video preds",torch.max(self.video_preds,1)[1])
            # print("self.videos labels",self.video_labels)
            # assert False
    ...
    def classify_longtail_classes(self,file):
        ...
        print("len head classes", len(head_classes))
        print("len med classes", len(med_classes))
        print("len tail classes", len(tail_classes))
