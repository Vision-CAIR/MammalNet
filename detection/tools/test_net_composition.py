...
def perform_test(test_loader, model, test_meter, cfg, writer=None):
    ...
    test_meter.finalize_metrics()
    # test_meter.finalize_metrics_group_by_counterpart()
...
def test(cfg):
    ...
    #         out_str_prefix,
    #         cfg.TEST.DATASET[0],
    #         test_meter.stats["animal_top1_acc"],
    #         test_meter.stats["animal_top1_acc"],
    #         test_meter.stats["animal_top5_acc"],
    #         misc.gpu_mem_usage(),
    #         cfg.TEST.DATASET[0],
    ...
    #         out_str_prefix,
    #         cfg.TEST.DATASET[0],
    #         test_meter.stats["behavior_top1_acc"],
    #         test_meter.stats["behavior_top1_acc"],
    #         test_meter.stats["behavior_top5_acc"],
    #         misc.gpu_mem_usage(),
    #         cfg.TEST.DATASET[0],
    #         cfg.MODEL.NUM_CLASSES,
    #     )
    ...
    #         out_str_prefix,
    #         cfg.TEST.DATASET[0],
    #         test_meter.stats["composition_top1_acc"],
    #         test_meter.stats["composition_top1_acc"],
    #         test_meter.stats["composition_top5_acc"],
    #         misc.gpu_mem_usage(),
    #         cfg.TEST.DATASET[0],
    #         cfg.MODEL.NUM_CLASSES,
    #     )
    ...
    #         test_meter.stats["perclass_animal_top1_acc"],
    #         test_meter.stats["perclass_animal_top5_acc"],
    #         misc.gpu_mem_usage(),
    #         cfg.TEST.DATASET[0],
    #         cfg.MODEL.NUM_CLASSES,
    #     )
    ...
    #         out_str_prefix,
    #         cfg.TEST.DATASET[0],
    #         test_meter.stats["perclass_behavior_top1_acc"],
    #         test_meter.stats["perclass_behavior_top1_acc"],
    #         test_meter.stats["perclass_behavior_top5_acc"],
    #         misc.gpu_mem_usage(),
    #         cfg.TEST.DATASET[0],
    #         cfg.MODEL.NUM_CLASSES,
    #     )
    ...
    #         out_str_prefix,
    #         cfg.TEST.DATASET[0],
    #         test_meter.stats["perclass_composition_top1_acc"],
    #         test_meter.stats["perclass_composition_top1_acc"],
    #         test_meter.stats["perclass_composition_top5_acc"],
    #         misc.gpu_mem_usage(),
    #         cfg.TEST.DATASET[0],
    #         cfg.MODEL.NUM_CLASSES,
    #     )
